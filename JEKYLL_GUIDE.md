...
- title: "My New Project with Video"
  ...
  description: "Description of your project here."
  image: "/images/new_project.png"
  hover_video: "/images/new_project.mp4"  # ← Just add this line!
```
...
- title: "My Project"
  ...
  video_presentation: "https://drive.google.com/file/d/..."  # Optional video link
```
...
- title: "Robot Learning Project"
  ...
  image: "/images/robot_project.png"
  image_title: "Image credit: DALL-E 3"
  hover_video: "/images/robot_project.mp4"
```
...
- Video paths start with `/images/` and end with `.mp4`
...
- title: "Learning Robot Manipulation Skills"
  ...
  image: "/images/manipulation_paper.png"
  image_title: "Image credit: DALL-E 3"
```
...
Place your video file in the `images/` folder:
```
images/
  my_project.mp4
```
...
- title: "My Project"
  ...
  hover_video: "/images/my_project.mp4"  # ← Add this line!
```
...
├── scripts.js           # JavaScript for video hover
├── stylesheet.css       # Your styles
├── images/              # Images and videos
├── data/                # PDFs and other files
...
1. Check file path: Should be `/images/filename.mp4`
2. Check file exists in `images/` folder
...
### Add Video Preview
1. Add video file to `images/` folder
2. Add `hover_video: "/images/filename.mp4"` to project entry
3. Save and push
